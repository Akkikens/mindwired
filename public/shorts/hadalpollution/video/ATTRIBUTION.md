# hadalpollution — video provenance

Every clip below is **NOAA Ocean Exploration**, a US federal work in the public
domain. NOAA requests the credit line "NOAA Ocean Exploration" — it is in the
video description.

**These are real deep-sea ROV dives, but they are NOT hadal.** NOAA works mostly
at 300-3,000 m and has no amphipod, snailfish, hadal, Mariana or abyssal footage
at all; genuine hadal film belongs to Schmidt/MBARI/Caladan, which are NC or
permission-only and stay barred. No caption in this episode asserts a depth or a
location the footage cannot support. The two animals the script actually names
are carried by real STILLS of those exact species, credited in images/ATTRIBUTION.md.

- `lander_1.mp4` — "Crab Defending Bait", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/explorations-19deepsearch-logs-apr14-media-lander-crab/
- `lander_2.mp4` — "Methane Bubbles", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/video-shorts-ex1302-bubbles/
- `lander_3.mp4` — "Vent Shrimp", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/video-shorts-ex1104-ventshrimp/
- `lander_4.mp4` — "Carbonate Rocks Flyover", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/explorations-20cascadia-seeps-logs-sept29-media-flyover/
- `lander_5.mp4` — "Cutthroat Eel", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/video-shorts-ex1905-eel-fishfood/
- `lander_6.mp4` — "Sampling on a Seamount", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/video-playlist-ex1702-sampling/
...
- `snailfish_1.mp4` — "Cusk Eel", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/video-shorts-ex1711-cuskeel/
- `snailfish_2.mp4` — "Slickhead", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/explorations-19biolum-logs-jun16-media-slickhead/
- `snailfish_3.mp4` — "Eelpout", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/okeanos-explorations-ex2104-dives-dive09-media-dive09-fish/
- `snailfish_4.mp4` — "Bathysaurus", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/video-shorts-ex1605l1-bathysaurus/
- `snailfish_5.mp4` — "Batfish", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/video-shorts-ex1605-pizzafish/
- `snailfish_6.mp4` — "Chimaera", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/video-shorts-ex1907-chimaera/
- `snailfish_7.mp4` — "Monkfish", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/video-shorts-ex1905-monkfish/
- `snailfish_8.mp4` — "First Sighting", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/video-playlist-ex1605-first-sighting/
- `snailfish_9.mp4` — "Fish Faces", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/video-playlist-ex1606-fishfaces/
- `rov_1.mp4` — "Engineering for Discovery", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/okeanos-explorations-ex1711-dailyupdates-media-video-d2-d2/
- `rov_2.mp4` — "Dumbo Octopus", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/video-shorts-ex1907-dumbo1/
- `marianamap_1.mp4` — "Mapping the Ocean: February - March 2016", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/video-playlist-technology-mapping/
- `marianamap_2.mp4` — "Mapping the “Ocean”", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/edu-themes-seafloor-mapping-media-video-multimedia-mapping/
...
- `coast_1.mp4` — "Buck Island Reef National Monument Highlights", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/okeanos-explorations-22voyage-to-the-ridge-features-return-pr-usvi-media-dive3/
- `coast_2.mp4` — "St. Croix’s Wonder Wall", NOAA Ocean Exploration — **public domain (US federal work)** — https://oceanexplorer.noaa.gov/multimedia/edu-themes-canyons-media-video-multimedia-wonder/

## Modern b-roll — Pexels (3 clips)

These three beats depict present-day industry and textiles, which NOAA has no
footage of and correctly returned nothing for. Per the repo rule, Pexels is used
for generic MODERN b-roll only and is never presented as archival.

- `textile_1.mp4` — "high speed textile weaving machine in action" (Pexels 30183333) — Pexels licence, free for commercial use
- `industry_1.mp4` — "aerial view of industrial complex at dusk" (Pexels 29308412) — Pexels licence, free for commercial use
- `industry_2.mp4` — "aerial footage of a factory full of smoke" (Pexels 14189690) — Pexels licence, free for commercial use

> Written back by hand 2026-09-13: the bulk NOAA downloader wrote this file at the
> end of its run and overwrote the credits `fetch_footage.py` had already logged for
> these three. Anything that rewrites an ATTRIBUTION.md wholesale must merge, not
> replace — a licence record that silently loses entries is worse than no record.
