/** Typed access to the rogue-planet episode audio manifest (George VO + score +
 *  word timings). Mirrors src/scariest/lib/manifest.ts. */
import manifestJson from "../../../public/rogueplanet/audio/manifest.json";
